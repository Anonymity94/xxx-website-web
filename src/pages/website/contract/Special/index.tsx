...
/** 附件表单分类ID */
export const SPECIAL_CONTRACT_CATEGORY_ID = -1;
/** 附件表单子分类ID */
export const SPECIAL_CONTRACT_SUB_CATEGORY_ID = -1;
        ...
        <ProList<IContract>
          ...
          request={async (params = {}) => {
            ...
            const newParams = {
              ...
              status: EStatus.Open,
              name: keyword,
              categoryId: SPECIAL_CONTRACT_CATEGORY_ID,
              subcategoryId: SPECIAL_CONTRACT_SUB_CATEGORY_ID,
            };
